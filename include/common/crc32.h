/**
 * NOTE: Uses polynomial 0xEDB88320
 */
 ...
 */
extern uint32_t crc32_calculate(const void *data, size_t length);
 ...
 */
extern uint32_t crc32_update(uint32_t crc, const void *data, size_t length);
 ...
 */
extern int crc32_verify(const void *data, size_t length, uint32_t expected_crc);
