...
CFLAGS          = $(INCLUDE_DIR) $(EFIINCS) -fno-stack-protector -fpic -fshort-wchar -mno-red-zone -I$(INC_DIR)
ifeq ($(ARCH),x86_64)
	CFLAGS += -DEFI_FUNCTION_WRAPPER
endif

LDFLAGS         = -znocombreloc -T $(EFI_LDS) -shared -Bsymbolic -L$(LIBDIR) $(EFI_CRT_OBJS) $(LIBRARY)
